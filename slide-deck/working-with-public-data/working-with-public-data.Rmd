---
title: "Working with Public Datasets"
subtitle: "Data Dialogues | Assam | March 21-22, 2022"
institute: "CivicDataLab"
date: "2022/03/22 (updated: `r Sys.Date()`)"
output:
...
xaringanExtra::use_logo("https://drive.google.com/uc?id=1WbdosVvi6SBjYtEF6kHj-f0wotdHMRgw",link_url = "https://civicdatalab.in",exclude_class = c("hide-logo"))
```
...
![](../../resources/title-slide-public-data.png)
...
Structured sources
  - Census of India
  - NCRB Crime Reports
  - All India Pincode directory along with Latitude and longitude
]
...
- There isn't any standard way to create a CSV file.
...
- CSV files are not meant for providing contextual information that can aid in automated processing of the data that they hold or even in informing users about how they should be interpreted.
...
.panel[
.panel-name[Table 1]
![](../../resources/table-1-tidy-data.png)
]

.panel[
.panel-name[Table 2]
![](../../resources/table-2-tidy-data.png)
]

.panel[
.panel-name[Tidy Dataset]
![](../../resources/table-3-tidy-data.png)
]
...
![](../../resources/formatting-table-1.png)

]

.panel[.panel-name[Better alternative]

![](../../resources/formatting-table-2.png)
]
]
...
.pull-left[.card[
![](../../resources/csv-lint-demo-2.png)
]]

.pull-right[
CSV looks easy, but it can be hard to make a CSV file that other people can work with. 

Online tools like [Good Tables](https://goodtables.io/) and [CSVLint](https://csvlint.io/) helps you to check that your CSV file is readable. And you can use it to check whether it contains the columns and types of values that it should.
]
---
...
![](https://camo.githubusercontent.com/bc24b782d1420f2262f976df305b804bf84933ef02c088d4babf7d536bff0ac1/68747470733a2f2f657863616c696275722d70792e72656164746865646f63732e696f2f656e2f6d61737465722f5f696d616765732f75736167652e676966)
...
Access the slides at - [https://bit.ly/data-dialogues-public-data](https://bit.ly/data-dialogues-public-data)
